      ...
      <div className="lesson-header">
        ...
        <div className="lesson-meta">
          ...
          <a
            ...
            className="lmeta-chip lmeta-link"
          >
      ...
      <div className="tab-content">
        ...
        {activeTab === "transcript" && (
          <div className="tab-panel">
            <div className="content-block">
              <h3 className="content-block-title">
                <AlignLeft size={16} /> Lesson Transcript
              </h3>
              <div className="transcript-text">
                {lesson.transcript_clean.split("\n\n").map((para, i) => (
                  <p key={i} className="transcript-para">{para}</p>
                ))}
                <div className="transcript-fade">
                  <span className="transcript-truncated">
                    Full transcript available in the AI Tutor →
                  </span>
                </div>
              </div>
            </div>
